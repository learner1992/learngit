...
_LOG_DIR = '/home/hadoop/data/python/hainiu_cralwer/log/%s'

#数据地址
# _LOCAL_DATA_DIR = 'D:\\tmp\\log\\data\\%s'
_LOCAL_DATA_DIR = '/home/hadoop/data/python/hainiu_cralwer/data/%s'
...
#数据库配置
_OGC_DB = {'HOST':'nn1.hadoop', 'USER':'root', 'PASSWD':'admin', 'DB':'ogc', 'CHARSET':'utf8', 'PORT':3306}
...
#KAFKA队列配置
_KAFKA_CONFIG = {'HOST':'nn1.hadoop:9092,nn2.hadoop:9092,s1.hadoop:9092', 'TOPIC':'file_html'}